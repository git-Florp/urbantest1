          ...
          <div className="glass-panel p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-black/40 border border-white/10 rounded-lg text-foreground font-mono text-sm focus:border-primary/50 focus:outline-none transition-colors"
